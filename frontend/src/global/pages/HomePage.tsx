...
import { IoAddCircleOutline, IoLogInOutline } from "react-icons/io5";
...
export const HomePage: FC = () => {
  ...
  const { activeTab } = useOutletContext<{ activeTab: TabId; setActiveTab: (tab: TabId) => void }>();
    ...
    return (
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="max-w-lg mx-auto p-6">
        <div className="text-center py-20">
          <h1 className="text-3xl font-bold text-text-primary mb-2">Love 6202</h1>
          <p className="text-text-secondary mb-8">소중한 순간을 함께 나누세요</p>
          <button
